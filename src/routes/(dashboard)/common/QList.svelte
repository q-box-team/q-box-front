  ...
  const questions = [
    {
      ...
      nickname: "물결의 무인",
      detail: "대용 교수님이 무슨 말을 하는지 이해를 못하겠어요",
      thumbUp: 3,
    },
    {
      img: "https://i.stack.imgur.com/frlIf.png",
      nickname: "감성의 나그네",
      detail: "CORS 216번 어떻게 푸나요ㅠㅠㅠ 알려주세요",
      thumbUp: 2,
    },
    {
      img: "https://avatars.githubusercontent.com/u/15474343?v=4",
...
<div
  class="flex-child_center f_column"
  style="width: calc(100% - 120px); margin: 0px 60px;"
>
  <div
  ...
  <div
    class="flex-child_j-start_a-start f_column wd_100p"
    style="flex: 0.8; gap: 5px;"
  >
    {#each questions as question}
      <div
        class="flex-child_j-start_a-center f_row wd_100p question"
        style="gap: 40px; height: 65px; padding: 0px 10px;"
      >
        <img
          src={question.img}
          alt=""
        ...
        <div
          ...
          style="flex: 0.05; gap: 10px; margin-right: 10px;"
        >
          <div class="material-icons" style="color: #fdc83a;">thumb_up</div>
          {question.thumbUp}
        </div>
      </div>
    {/each}
